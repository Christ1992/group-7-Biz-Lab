...
var weatherDressApp = angular.module('weatherDress', ['ngRoute','ngResource','ngCookies','ngSanitize','angulartics','angulartics.google.analytics','720kb.socialshare','firebase','auth0', 'angular-storage', 'angular-jwt']);
